@extends('layouts.admin-master', ['pageName' => 'testimonial', 'title' => 'Edit Testimonial'])
                                ...
                                <form action="{{ route('testimonial.update', $testimonial->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <label for="title">Testimonial Title <span class="text-danger"> * </span></label>
                                            <input class="form-control @error('title') is-invalid @enderror" id="title"
                                                type="text" name="title" value="{{ $testimonial->title }}"
