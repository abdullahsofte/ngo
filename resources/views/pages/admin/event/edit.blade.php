@extends('layouts.admin-master', ['pageName' => 'Event', 'title' => 'Edit Event'])
                ...
                <div class="col-md-12">
                    <div class="card height-auto">
                        <div class="d-flex justify-content-between heading card-header">
                            <h4 class=""><i class="fa fa-edit"></i> Edit Event</h4>
                        </div>
                        <div class="card-body">
                            <div class="form">
...
@push('admin-js')
    ...
    <script>
        ...
        document.getElementById("previewImage").src = "{{ asset($event->image) }}";
    </script>
