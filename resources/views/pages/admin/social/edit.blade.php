@extends('layouts.admin-master', ['pageName'=> 'social', 'title' => 'Edit Social Link'])
                    ...
                    <div class="card-body">
                        <div class="form">
                            <div class="d-flex justify-content-between heading card-header">
                                <h4 class=""><i class="fa fa-edit"></i> Edit Social Link</h4>
                                <div>
                            ...
                            <form action="{{ route('social.update', $social) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-2">
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('name') is-invalid @enderror" id="name" type="text" name="name" value="{{ $social->name }}" placeholder="name">
                                            @error('name')
                                        ...
                                        <div class="row my-2">
                                            ...
                                            <div class="col-md-9">
                                            <input class="form-control @error('link') is-invalid @enderror" id="link" type="text" name="link" value="{{ $social->link }}" placeholder="link">
                                            @error('link')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="clearfix mt-1">
                                    <div class="float-md-left">
                                        <a href="{{route('social.index')}}" id="prev" class="btn-fill-lg bg-blue-dark btn-hover-yellow">Back</a>
...
<script>
    ...
    document.getElementById("previewImage").src="{{ asset($social->image) }}";
</script>
@endpush