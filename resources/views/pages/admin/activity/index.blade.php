@extends('layouts.admin-master', ['pageName' => 'activity', 'title' => 'Add activites'])
@push('admin-css')
@endpush
                ...
                <div class="col-md-12">
                    <div class="card height-auto">
                        <div class="d-flex justify-content-between heading card-header">
                            <h4 class=""><i class="fas fa-plus"></i> Add new Activites</h4>
                        </div>
                        <div class="card-body">
                            <div class="form">
                                ...
                                <form action="{{ route('activity.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="row my-2">
                                                <div class="col-md-3">
                                                    <label for="rank"> Rank <span class="text-danger"> *
                                                        </span></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input
                                                        class="form-control form-control-sm @error('rank') is-invalid @enderror"
                                                        id="rank" type="text" name="rank"
                                            ...
                                            <div class="row my-2">
                                                <div class="col-md-3">
                                                    <label for="image" class=""> Image <small>(Size:
                                                            500*400px)</small></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input
                            ...
                            <tbody>
                                @forelse ($activity as $key=>$item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('activity.edit', $item) }}" class="btn btn-info btn-sm"><i
                                                    class="fa fa-edit"></i></a>
                                            <button type="submit" class="btn btn-danger btn-sm"
                                                onclick="deletePartner({{ $item->id }})"><i
                                                    class="fa fa-trash"></i></button>
                                            <form id="delete-form-{{ $item->id }}"
                                                action="{{ route('activity.delete', $item) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
