@extends('layouts.admin-master', ['pageName' => 'project', 'title' => 'Edit Project'])
                ...
                <div class="col-md-12">
                    <div class="card height-auto">
                        <div class="d-flex justify-content-between heading card-header">
                            <h4 class=""><i class="fa fa-edit"></i> Edit Project</h4>
                        </div>
                        <div class="card-body">
                            <div class="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input class="form-control @error('title') is-invalid @enderror" id="title"
                                                type="text" name="title" value="{{ $project->title }}"
...
@push('admin-js')
    ...
    <script>
        ...
        document.getElementById("previewImage").src = "{{ asset($project->image) }}";
    </script>
