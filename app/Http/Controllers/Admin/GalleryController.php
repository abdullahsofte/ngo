...
class GalleryController extends Controller
{
    ...
    public function galleryInsert(Request $request)
    {
        ...
        try {
            ...
            Image::make($image)->resize(600, 400)->save($upLocation . $imgName);
            //close image upload
    ...
    public function galleryUpdate(Request $request, $id)
    {
        ...
        try {
            ...
            if ($image) {
                ...
                Image::make($image)->resize(600, 400)->save('uploads/gallery/' . $imageName);
            ...
            $gallery->save();
            DB::commit();
            return Redirect()->route('gallery.index')->with("success", "Update Successfull");
        } catch (\Exception $e) {
            DB::rollback();
